...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // URL de l'API
  final String apiUrl = 'http://10.0.2.2:8000/api/chat/send_message/'; // Remplacez par votre URL d'API
      ...
      try {
        ...
        final response = await http.post(
          ...
          body: json.encode({'message': message,
            'user_id': 1  // Remplace 1 par l'ID de l'utilisateur connecté
          }),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: const AppDrawer(), // Inclure le menu latéral
      body: SafeArea(
        child: Column(
          children: [
